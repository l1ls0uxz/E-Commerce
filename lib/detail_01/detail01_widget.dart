...
class Detail01Widget extends StatefulWidget {
  const Detail01Widget({Key? key}) : super(key: key);

  @override
  _Detail01WidgetState createState() => _Detail01WidgetState();
}

class _Detail01WidgetState extends State<Detail01Widget>

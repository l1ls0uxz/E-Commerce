...
class Detail06Widget extends StatefulWidget {
  const Detail06Widget({Key? key}) : super(key: key);

  @override
  _Detail06WidgetState createState() => _Detail06WidgetState();
}

class _Detail06WidgetState extends State<Detail06Widget>

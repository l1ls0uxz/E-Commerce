...
class Detail04Widget extends StatefulWidget {
  const Detail04Widget({Key? key}) : super(key: key);

  @override
  _Detail04WidgetState createState() => _Detail04WidgetState();
}

class _Detail04WidgetState extends State<Detail04Widget>

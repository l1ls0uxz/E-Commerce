...
class Detail03Widget extends StatefulWidget {
  const Detail03Widget({Key? key}) : super(key: key);

  @override
  _Detail03WidgetState createState() => _Detail03WidgetState();
}

class _Detail03WidgetState extends State<Detail03Widget>

...
class Detail05Widget extends StatefulWidget {
  const Detail05Widget({Key? key}) : super(key: key);

  @override
  _Detail05WidgetState createState() => _Detail05WidgetState();
}

class _Detail05WidgetState extends State<Detail05Widget>
